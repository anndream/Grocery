...
import { Box, Image, Content, Title, Description, SearchWrapper } from "./banner.style";
...
export const Banner: React.FC<Props> = ({ style, imageUrl, intlTitleId, intlDescriptionId }) => {
