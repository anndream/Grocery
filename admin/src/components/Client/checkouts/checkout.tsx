...
const OrderItem: React.FC<CartItemProps> = ({ product }) => {
  const { id, quantity, title, name, unit, unit_price, discount_amount } = product;
    ...
    <form>
      <CheckoutWrapper>
        <CheckoutContainer>
            ...
            <InformationBox className="paymentBox" style={{ paddingBottom: 30 }}>
              ...
              <CheckoutSubmit>
                <Button
                  ...
                  style={{ width: "100%" }}
                >
                  <FormattedMessage id="processCheckout" defaultMessage="Proceed to Checkout" />
                </Button>
              </CheckoutSubmit>
            </InformationBox>
          </CheckoutInformation>
          ...
          <CartWrapper>
            <Sticky enabled={size.width >= 768 ? true : false} top={120} innerZ={999}>
              <OrderInfo>
                <Title>
