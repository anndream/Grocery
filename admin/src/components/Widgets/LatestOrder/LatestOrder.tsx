...
import { Col as Column } from "components/Admin/FlexBox/FlexBox";
import Input, { SIZE } from "components/Admin/Input/Input";
              ...
              data.orders
                ...
                .map((row, index) => (
                  <StyledRow key={index}>
                    ...
                    <StyledCell>{dayjs(row[1]).format("DD MMM YYYY")}</StyledCell>
