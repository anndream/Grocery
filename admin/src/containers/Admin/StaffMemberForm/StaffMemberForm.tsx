      ...
      <Form onSubmit={handleSubmit(onSubmit)} style={{ height: "100%" }}>
        ...
        >
            ...
            <Col lg={8}>
              <DrawerBox>
                <FormFields>
                  ...
                  <Input inputRef={register({ required: true, maxLength: 20 })} name="first_name" />
                </FormFields>

                <FormFields>
                  <FormLabel>Last Name</FormLabel>
                  <Input inputRef={register({ required: true, maxLength: 20 })} name="last_name" />
                </FormFields>
                ...
                <FormFields>
                  ...
                  <Input type="email" inputRef={register({ required: true })} name="email" />
                </FormFields>
              </DrawerBox>
            </Col>
          </Row>
          ...
          <Row>
            <Col lg={4}>
              <FieldDetails>
                Expand or restrict user’s permissions to access certain part of pickbazar system.
              </FieldDetails>
            </Col>
