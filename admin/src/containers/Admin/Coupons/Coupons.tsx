                      ...
                      .map((row, index) => {
                        return (
                          <React.Fragment key={index}>
                            ...
                            <StyledBodyCell>{dayjs(row[6]).format("DD MMM YYYY")}</StyledBodyCell>
                            <StyledBodyCell>{dayjs(row[7]).format("DD MMM YYYY")}</StyledBodyCell>
                            <StyledBodyCell>
                              <Status
                                className={
                                  row[8] === "active" ? active : row[8] === "revoked" ? revoked : ""
                                }
                              >
                                {row[8]}
                              </Status>
